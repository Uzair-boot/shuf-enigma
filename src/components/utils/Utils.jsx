...
import ecom from "../../assets/Home/ecom.png";
import it from "../../assets/Home/it.png";
...
import awsservices from "../../assets/Home/awsservice.png";
...
export const homeFeature = [
  {
    img: <BrushOutlinedIcon style={{ fontSize: "52px" }}></BrushOutlinedIcon>,
    name: "Creative Design",
    desc: `Universal and accessible to all components. Well tested to ensure performance and
     reliability. Straightforward APIs with consistent cross-platform behavior. Unique and 
     memorable designs that stand out.`,
  },

  {
    img: <SupportAgentIcon style={{ fontSize: "52px" }}></SupportAgentIcon>,
    name: "24/7 Support",
    desc: `We provide high-quality services all around the world with personal 
    assistance through our 24/7 service for all our customers. It doesn’t matter 
    what environment you’re working in, or where your project is located, we will
     be ready to help you and offer you a solution.`,
  },
  {
    img: (
    ...
    desc: `Quality is the most important factor in today's business landscape. 
    We provide tangibility, reliability, responsiveness, assurance, and empathy to our customers.`,
  },
  {
    img: <DeliveryDiningIcon style={{ fontSize: "52px" }}></DeliveryDiningIcon>,
    name: "On-time Delivery",
    desc: `We want our customers to have a positive experience in all their dealings with us. 
    We aim at fulfilling our customers’ expectations and assumptions 110% by our skill sets.`,
  },
  {
    img: <EmojiObjectsIcon style={{ fontSize: "52px" }}></EmojiObjectsIcon>,
    name: "Innovative",
    desc: `We have helped businesses throughout the world by identifying, 
    pinpointing, and understanding their needs to improve their online 
    representation and provide them with best business solutions.`,
  },
  {
    img: <DeveloperModeIcon style={{ fontSize: "52px" }}></DeveloperModeIcon>,
    name: "Development",
    desc: `Our technology team develops secure, stable, 
    scalable and innovative cross-platform Apps by fostering 
    technological innovation and flawless engineering.`,
  },
];
...
export const testimonial = [
  {
    name: "Andreas Marco Jensen",
    companyName: "The Hub",
    img: star,
    desc: `Every teamplayer of QUH Dock is a very professional developer who cares greatly for the delivery. I was very pleased with the result.`,
  },

  {
    name: "Neil Jospeh",
    companyName: "Promise Tech",
    img: star,
    desc: `Really pleasant experience working with QUH Dock, was able to bounce ideas off of him as well as work efficiently using latest technologies.`,
  },

  {
    name: "Marie",
    companyName: "Marketing Honeypot",
    img: star,
    desc: `Excellent technical skills and expertise in delivering improvements and new features in JavaScript applications. Proactive attitude and great communication.`,
  },

  {
    name: "Gaoqing Yang",
    companyName: "Belo Labs",
    img: star,
    desc: `Great work! GQL to Rest migration was done very well. Looking forward to working with in the future.`,
  },

  {
    ...
    companyName: "SysPos",
    img: star,
    desc: `one of the best developers i worked with, he always gives extra effort for the best results, will work again for sure!.`,
  },

  {
    name: "Zahid Sharif ",
    companyName: "Inspections",
    img: star,
    desc: `Excellent QUH Dock. Saved our project and motivated the other whole team. Excellent attention to detail. Highly recommend them.`,
  },

  {
    name: "Vikas Ramaiah",
    companyName: "Greenery Guard",
    img: star,
    desc: `Passionate Team and fast thinker. QUH Dock always find solution to unique problems and build excellent logic of problems.`,
  },

  {
    name: "Roger Hoover",
    companyName: " Get Response",
    img: star,
    desc: `Completed my project exceptionally fast and got it the first time. Was easy to communicate with. Will definitely work with again.`,
  },

  {
    name: "Sulayman",
    companyName: "Hepc-path-tool",
    img: star,
    desc: `It was very great experience with QUH Dock. Team effort was very recognizable. They fulfilled all our requirements about our Project.`,
  },

  {
    name: "Micheal",
    companyName: "Turn Base Studio",
    img: star,
    desc: `A fantastic organization, providing eye catchy and elegent UI Designs.Pixal perfect and organize UI deliverd.`,
  },

  {
    name: "Jim",
    companyName: "The Spacewar (cards game)",
    img: star,
    desc: `A fantastic organization, providing eye catchy and elegent UI Designs.Pixal perfect and organize UI deliverd.`,
  },
];
